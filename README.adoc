...
image::http://ForTheBadge.com/images/badges/built-with-love.svg[love,250]


include::src/main/asciidoc/http-request.adoc[]
include::src/main/asciidoc/http-response.adoc[]